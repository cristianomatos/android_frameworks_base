 ...
 */
public class StatusBarClockCenter extends ClockCenter {
    private final int mDSBDuration;

    public StatusBarClockCenter(final Context context) {
        this(context, null);
    }

    public StatusBarClockCenter(final Context context, final AttributeSet attrs) {
    ...
    public StatusBarClockCenter(final Context context, final AttributeSet attrs,
        ...
        BarBackgroundUpdater.addListener(new BarBackgroundUpdater.UpdateListener(this) {
            ...
            public ObjectAnimator onUpdateStatusBarIconColor(final int previousIconColor,
                ...
                return ObjectAnimator.ofObject(StatusBarClockCenter.this, "textColor",
